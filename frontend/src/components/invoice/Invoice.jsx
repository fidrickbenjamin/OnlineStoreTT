        ...
        <div id="order_invoice" className="p-3 border border-secondary">
          <header className="clearfix">
            ...
            <div id="company" className="clearfix">
              <div>Tactical Trends</div>
              <div>
                Pine Square Wesley,
                <br />
                Roseau 00109, DOM
              </div>
              <div>(767) 285-8487</div>
              <div>
                <Link to="mailto:info@shopit.com">info@tactical-trends.com </Link>
              </div>
            </div>
            <div id="project">
              ...
              <div><span> Status: </span> <span className={isPaid ?"greenColor":"redColor"} > {paymentInfo?.status} </span></div>
