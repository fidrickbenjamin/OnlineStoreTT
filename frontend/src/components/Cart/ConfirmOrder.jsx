...
const ConfirmOrder = () => {
  ...
  // Effect to ensure shippingInfo is available
  useEffect(() => {
    if (!shippingInfo) {
      // Navigate to the shipping info page or show an alert if necessary
      navigate('/shipping'); // or you can handle as per your routing
    }
